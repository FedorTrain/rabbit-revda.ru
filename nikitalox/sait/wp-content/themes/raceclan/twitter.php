...
Description: Displays your public Twitter messages for all to read. Based on.
...
function twitter_messages($username = '', $num = 5, $list = false, $update = true, $linked  = '#', $hyperlinks = true, $twitter_users = true, $encode_utf8 = false) {
