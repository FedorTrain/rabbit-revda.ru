...
define('DDSG_NAV1_PREV', 'Предыдущая');
define('DDSG_NAV1_NEXT', 'Следующая');

// Navigation method 2
// Example: Pages: 1 2 3 4 5

define('DDSG_NAV2_PAGE', 'Страницы:');
...
define('DDSG_LANGUAGE_DESC', 'Language files are located in <strong>/wp-content/plugins/dd-sitemap-gen/lang/</strong>');
